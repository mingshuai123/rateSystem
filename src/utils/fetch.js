...
var baseURL='http://192.168.0.128:1388/api/'
var baseURL='https://api.iasac.org.cn/front/api/'
...
function apiAxios2 (method, url, params) {
  let token=sessionStorage.getItem('token');
  // console.log(params)
  if(url.indexOf('?')>=0){
    var urldata = {};
...
export default {
  install: function (Vue) {
    ...
    Vue.prototype.postAxios2 = (url, params) => apiAxios2('POST', url, params)
